...
+ (NSString *)deviceTypeName {
    ...
    //参考来源：https://en.wikipedia.org/wiki/List_of_iOS_devices
    //iPhone
    ...
    if([platform isEqualToString:@"iPad6,3"])   return@"iPad Pro 9.7 1G";
    if([platform isEqualToString:@"iPad6,4"])   return@"iPad Pro 9.7 1G";
    if([platform isEqualToString:@"iPad6,7"])   return@"iPad Pro 12.9 1G";
    if([platform isEqualToString:@"iPad6,8"])   return@"iPad Pro 12.9 1G";
    ...
    if([platform isEqualToString:@"iPad7,3"])   return@"iPad Pro 10.5 1G";
    if([platform isEqualToString:@"iPad7,4"])   return@"iPad Pro 10.5 1G";
    if([platform isEqualToString:@"iPad7,5"])   return@"iPad 2018";
    if([platform isEqualToString:@"iPad7,6"])   return@"iPad 2018";
